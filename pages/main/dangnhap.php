...
<form action="" method="POST" autocomplete="off">
  ...
  <input type="submit" name="dangnhap" value="Đăng Nhập" class="login-btn" style="padding: 5px 40px; margin-top: 30px; 
  ...
  <p class="text-register" style="margin-top: 8px;       font-size: 12px;       margin-left: 15px;">            Bạn chưa có tài khoản?
            <span >
              <a href="index.php?quanly=dangky" style="cursor: help;         color: #0d3aee;">Đăng ký</a>
            </span>
          </p>
...
<!-- <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <form class="auth-login-form mt-2" action="index.html" method="POST" novalidate="novalidate">
                                    ...
                                    <button class="login-btn" tabindex="4">Sign in</button>
                                </form>
                                ...
                                <div class="auth-footer-btn d-flex justify-content-center">
                                    <a href="javascript:void(0)" class="btn btn-facebook waves-effect waves-float waves-light">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-twitter white waves-effect waves-float waves-light">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-twitter"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path></svg>
                                    </a>
                                    <a href="javascript:void(0)" class="btn btn-google waves-effect waves-float waves-light">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                    </a>
                                    <a href="javascript:void(0)" class="btn btn-github waves-effect waves-float waves-light">
