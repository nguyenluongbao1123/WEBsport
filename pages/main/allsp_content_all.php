<?php
$sql_pro = "SELECT * FROM tbl_sanpham,tbl_danhmuc,tbl_band WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND tbl_sanpham.id_band=tbl_band.id_band ORDER BY tbl_sanpham.id_sanpham DESC LIMIT 20";
